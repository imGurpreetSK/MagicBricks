...
//                                                dialog.setContentView(R.layout.dialog_layout);
                                                ...
                                                textmob.setText(mobile);
                                                textprice.setText(price);
                                                textbath.setText(bathroom);
                                                textcov.setText(covArea);
                                                textage.setText(ageOfConstruction);
                                                texttrans.setText(transType);
                                                textcity.setText(city);
                                                textloc.setText(locality);
